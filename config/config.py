...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Team-Alisha/YukkiMusicBot",
)
...
# Images
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph//file/d219eba30ef6e639dc955.jpg")
